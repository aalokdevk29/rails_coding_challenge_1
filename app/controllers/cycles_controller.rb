class CyclesController < ApplicationController
  ...
  def new
    @cycle = Cycle.new
    @component = @cycle.components.build
    @component.subcomponents.build
    @component.build_impect
  end
  ...
  def cycle_params
    params.require(:cycle).permit(:name, components_attributes: %i[id name subcomponents _destroy])
  end
end
